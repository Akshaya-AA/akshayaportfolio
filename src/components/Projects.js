...
function Projects() {
  const projects = [
    ...
    },
    {
      ...
      desc: 'Built a complete Ecommerce Website with product listing, Add to Cart, and dynamic data storage using MySQL and Express backend. Users can add, update, and delete products easily with a modern responsive UI.',
      tech: 'MySQL | Node.js | Express | React.js',
      clientLink: 'https://github.com/Akshaya-AA/myshop-frontend',
      serverLink: 'https://github.com/Akshaya-AA/myshop-backend',
      img: require('../images/project5.jpg'),
    },
    {
              ...
              <div className="project-content">
                ...
                <div className="project-buttons">
                  {project.title === 'Ecommerce Website' ? (
                    <>
                      <a href={project.clientLink} className="project-btn" target="_blank" rel="noopener noreferrer">
                        <FaGithub /> GitHub
                      </a>
                      <a href={project.serverLink} className="project-btn" target="_blank" rel="noopener noreferrer">
                        <FaGithub /> GitHub
                      </a>
                    </>
                  ) : (
